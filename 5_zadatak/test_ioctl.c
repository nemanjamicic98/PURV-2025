...
int main()
{
		...
		int32_t cells[9];
		int32_t novi_centar;		//centar celije
		
		//Unos 9 stanja clija po redu (3x3) 
		...
		{
			perror("Ioctl write failed");		//pisanje u ioctl nije uspijesno
			close(fd);
			return 1;
		}
		
		//Citanje novih vrijednosti-statusa centralne celije
